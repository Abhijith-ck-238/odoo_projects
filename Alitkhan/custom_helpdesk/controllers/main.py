...
class XLSXReportController(http.Controller):
    @http.route('/custom_helpdesk_xlsx',type='http',auth='user',methods=['POST'],csrf=False)
    ...
    def get_report_xlsx(self,model,options,output_format,report_name,**kw):
        ...
        try :
            if output_format == "custom_helpdesk_xlsx":
                ...
                report_object.generate_xlsx_report(options,response)
