{
    ...
    'data': [
        ...
        # 'view/analytic_distribution.xml',
        # 'view/ir_attachment_view.xml'
        'view/hr_expense_view_inherit.xml',
        'view/expense_journal_view.xml',
    ],
    # 'assets': {
    #     'web.assets_backend': [
    #         'custom_expense/static/src/components/analytic_distribution/analytic_distribution.js',
    #         'custom_expense/static/src/components/analytic_distribution/analytic_distribution.xml',
    #     ]
    # },
    'installable': True,
    'application': True,
