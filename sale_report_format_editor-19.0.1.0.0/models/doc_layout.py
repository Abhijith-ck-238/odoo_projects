...
class DocLayout(models.Model):
    ...
    is_sales_person = fields.Boolean(string='Sales person', default=True,
                                  help="Display sale person of the sale")
    is_description = fields.Boolean(string='Description', default=True,
                                 help="Display product description")
    is_tax_value = fields.Boolean(string='Tax', help="Applied tax of order line")
    is_reference = fields.Boolean(string='Customer Reference',
    ...
    is_address = fields.Boolean(string='Address',
                             help="Display customer address")
    is_city = fields.Boolean(string='City',
                          help="Display city of customer address")
    is_country = fields.Boolean(string='Country',
                             help="Display country of customer address")
    company_id = fields.Many2one('res.company', string='Company',
                                 help="Current Company",
                                 default=lambda self: self.env.company)
    is_vat = fields.Boolean(string='VAT', default=True,
                         help='Customer vat id')
    is_watermark = fields.Boolean(string='Watermark', help="Watermark on report",
                               related='company_id.is_watermark',
                               readonly=False)
