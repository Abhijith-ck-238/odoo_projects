...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            '/stock_3d_view/static/src/js/form_3d_stock.js',
            '/stock_3d_view/static/src/js/list_3d_stock.js',
            ...
            '/stock_3d_view/static/src/js/three.js',
            '/stock_3d_view/static/src/js/OrbitControls.js',
        ],
    },
    'images': [
