...
class FleetVehicle(models.Model):
    ...
    utilize the existing functionality for managing vehicle details.
    It provides a structured way to access and utilize vehicle information
    within a fleet management context."""
