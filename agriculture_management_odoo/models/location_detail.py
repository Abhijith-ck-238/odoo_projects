...
class LocationDetail(models.Model):
    """This model represents comprehensive details about locations within
     ...
     information related to various geographic locations, such as farms,
     fields, or storage areas. """
    ...
    location_address = fields.Char(string='Location Address', required=True,
                                   help='Give the full address of the '
                                        'location',
                                   tracking=True)
    ...
    note = fields.Text(string='Note', tracking=True,
                       help='If any description for the location, '
                            'mention here')
