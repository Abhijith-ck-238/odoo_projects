...
class CropMachinery(models.Model):
    ...
    request records. It provides a structured way to associate
    machinery-related information with specific crop requests."""
    ...
    qty = fields.Integer(string='Quantity',
                         help="The Number of the vehicle that used for "
                              "farming")
