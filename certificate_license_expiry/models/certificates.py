...
class CertificatesType(models.Model):
    ...
    _certificate_type_unique = models.Constraint(
        'unique (certificate_type_unique)',
...
class CertificateTags(models.Model):
    ...
    # _sql_constraints = [(
    _certificate_tag_unique = models.Constraint(
        'unique (certificates_tags)',
